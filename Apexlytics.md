...
This app does not require an account and does not collect personal information such as
your name, email address, or any form of identity.
...
### API Requests
The app fetches Apex Legends game data (map rotations, ranked data) from a proxy server
operated by the developer. Standard server logs may record:
- Your IP address
- Request timestamps
- Request type (e.g. map rotation, ranked data)

This data is not linked to your identity, not shared with third parties, and server
logs are deleted on a rolling 30-day basis.
